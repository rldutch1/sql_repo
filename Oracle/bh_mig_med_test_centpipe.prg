drop program bh_mig_med_test_centpipe go
create program bh_mig_med_test_centpipe
...
;Example
;bh_mig_med_test_centpipe "mine","BPMC_i_950001_1000000_count_407_60.csv","CENTRICITY","60" go
...
where
	c.CONTRIBUTOR_SOURCE = "CENTRICITY"
detail
