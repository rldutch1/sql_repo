...
$result=mysql_query("select * from states",$conn);
...
$pdf->SetX(5);
$pdf->MultiCell(15,6,$column_state,1);
//$pdf->SetY($Y_Table_Position);
//$pdf->SetX(20);
